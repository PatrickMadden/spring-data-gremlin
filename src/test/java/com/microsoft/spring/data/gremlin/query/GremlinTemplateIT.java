...
public class GremlinTemplateIT {
    ...
    private final GremlinEntityInformation<Person, String> personInfo = GremlinEntityInformation.get(Person.class);
    private final GremlinEntityInformation<Project, String> projectInfo = GremlinEntityInformation.get(Project.class);
