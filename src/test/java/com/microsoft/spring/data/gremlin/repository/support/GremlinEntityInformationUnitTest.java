...
public class GremlinEntityInformationUnitTest {
    ...
    public void testVertexEntityInformation() {
        ...
        final GremlinEntityInformation<Person, String> personInfo = GremlinEntityInformation.get(Person.class);
    ...
    public void testEntityInformationException() {
        GremlinEntityInformation.get(TestDomain.class).createGremlinSource();
    }
